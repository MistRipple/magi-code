...
pub(crate) fn tool_execution_status_label(status: ExecutionResultStatus) -> &'static str {
    match status {
...
pub(crate) fn turn_item_status_for_tool_result(status: ExecutionResultStatus) -> &'static str {
    match status {
...
pub(crate) fn infer_tool_call_status(result: &str) -> &'static str {
