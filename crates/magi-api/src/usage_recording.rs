...
pub(crate) fn session_turn_model_usage_binding(use_tools: bool) -> ModelUsageBinding {
    ModelUsageBinding {
...
pub(crate) fn model_usage_binding_for_worker(
    worker: &WorkerInfo,
    is_primary: bool,
) -> ModelUsageBinding {
    if is_primary {
...
pub(crate) fn publish_model_usage_record(
