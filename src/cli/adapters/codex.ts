 ...
 * 支持会话恢复功能
 */
export class CodexAdapter extends EventEmitter implements ICLIAdapter {
   ...
   * 从 Codex 输出中提取描述文本
   */
  private static extractDescriptionFromOutput(output: string): string {
  ...
  /** 构建命令行参数 */
  private buildArgs(message: string, imagePaths?: string[]): string[] {
